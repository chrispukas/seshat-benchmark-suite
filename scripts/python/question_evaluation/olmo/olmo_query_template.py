...
from llm_benchmark.utils.llm_interface.models.local.olmo import OlmoInterfaceModule
...
def setup_model(model_name: str) -> OlmoInterfaceModule:
    return OlmoInterfaceModule(
...
def query(model_name: str = "deepseek-ai/deepseek-llm-7b-chat"):
    ...
    question_instance: OlmoInterfaceModule = setup_model(model_name=args.model_name)
