...
from llm_benchmark.utils.llm_interface.models.local.deepseek import DeepSeekInterfaceModule
...
def setup_model(model_name: str):
    return DeepSeekInterfaceModule(
...
def query(model_name: str = "deepseek-ai/deepseek-llm-7b-chat"):
    ...
    question_instance: DeepSeekInterfaceModule = setup_model(model_name=args.model_name)
