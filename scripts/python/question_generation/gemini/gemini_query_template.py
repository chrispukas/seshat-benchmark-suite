...
from llm_benchmark.utils.llm_interface.models.remote.gemini import GeminiInterfaceModule
...
def query(
        ...
        api_key: str = "", 
        polities_to_evaluate: List[str] = ["ec", "sc", "rt"]
        ):
    ...
    parser = argparse.ArgumentParser(description="Querying Gemini Model")
    parser.add_argument("--model_name", type=str, default=model_name, help="Identifier of the Gemini model to use")
    ...
    model_instance: GeminiInterfaceModule = GeminiInterfaceModule(
