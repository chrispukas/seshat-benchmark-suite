...
datasets=("/Users/apple/Documents/github/neurips_llms/llm-bechmark/db/gen/final/gpt-4.1-2025-04-14" "/Users/apple/Documents/github/neurips_llms/llm-bechmark/db/gen/final/gpt-5.2-2025-12-11")
...
for dataset in "${datasets[@]}"; do
    for model in "${models[@]}"; do
        ...
        python "$PYTHON_SCRIPT" --model_name "$model" --unhydrated_question_save_path "$dataset" --batch_size 1
    done
done