...
class GLMInterfaceModule(LLMInterfaceModule):
    def __init__(
        self,
    ...
    def query_model(
        ...
        if self.model is None or self.tokenizer is None:
            raise RuntimeError("GLM model is not initialized.")
        ...
        for message in messages:
            if not message:
                outputs.append(("", None, [], {"error": "Message is empty"}))
                continue
            ...
            try:
                ...
                logger.exception("GLM inference failed: %s", exc)
                outputs.append((
                    "",
                    None,
                    message,
